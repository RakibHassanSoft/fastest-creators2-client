...
const PreviousWork = () => {
  const works = [
    ...
    },
    {
      ...
      experience: "High-end visual showcase for award-winning photographers.",
        ...
        <div className="relative space-y-[4vh] ">
          {works.map((work, index) => {
            ...
            return (
              ...
              >
                <div className="w-full h-full bg-white  border-gray-100   overflow-hidden flex flex-col md:flex-row group p-1 ">
                  {/* Left Side: Alternating linear (Odd: Black, Even: Blue) */}
                  <div
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <span
                        className={`${isOdd ? "text-gray-400" : "text-blue-100"} uppercase tracking-widest text-2xl font-black opacity-80`}
                      >
                        Project 0{index + 1}
                      </span>
                  ...
                  <div className="w-full md:w-2/3 p-8 md:p-12 bg-white flex flex-col justify-center space-y-8 relative">
                    ...
                    <div className="space-y-2">
                      <h4
                        className={`${isOdd ? "text-gray-400" : "text-blue-600"} font-bold text-xs uppercase tracking-wider`}
                      >
                        The Experience
                      </h4>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      >
                        <h4
                          className={`font-bold text-[10px] uppercase mb-2 ${isOdd ? "text-black" : "text-blue-600"}`}
                        >
                          Our Solution
                        </h4>
